...
pub trait tick {
    ...
    fn tick(&self, arg: Ticker) -> __sdk::Result<()>;
    ...
    fn on_tick(
        &self,
        callback: impl FnMut(&super::ReducerEventContext, &Ticker) + Send + 'static,
    ) -> TickCallbackId;
...
impl tick for super::RemoteReducers {
    ...
    fn on_tick(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &Ticker) + Send + 'static,
    ) -> TickCallbackId {
