...
pub mod asset_file_type;
pub mod assets_table;
pub mod chunk_data_type;
pub mod chunk_table;
pub mod edit_asset_reducer;
pub mod player_table;
pub mod player_type;
pub mod script_asset_type;
pub mod scripts_table;
pub mod tick_reducer;
pub mod ticker_table;
pub mod ticker_type;

pub use asset_file_type::AssetFile;
pub use assets_table::*;
pub use chunk_data_type::ChunkData;
pub use chunk_table::*;
pub use edit_asset_reducer::{edit_asset, set_flags_for_edit_asset, EditAssetCallbackId};
pub use player_table::*;
pub use player_type::Player;
pub use script_asset_type::ScriptAsset;
pub use scripts_table::*;
pub use tick_reducer::{set_flags_for_tick, tick, TickCallbackId};
pub use ticker_table::*;
pub use ticker_type::Ticker;
...
pub enum Reducer {
    EditAsset { path: String, value: Vec<u8> },
    Tick { arg: Ticker },
}
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "edit_asset" => Ok(
                __sdk::parse_reducer_args::<edit_asset_reducer::EditAssetArgs>(
                    "edit_asset",
                    &value.args,
                )?
                .into(),
...
#[doc(hidden)]
pub struct DbUpdate {
    assets: __sdk::TableUpdate<AssetFile>,
    chunk: __sdk::TableUpdate<ChunkData>,
    player: __sdk::TableUpdate<Player>,
    scripts: __sdk::TableUpdate<ScriptAsset>,
    ticker: __sdk::TableUpdate<Ticker>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "assets" => db_update
                    .assets
                    .append(assets_table::parse_table_update(table_update)?),
                "chunk" => db_update
                    .chunk
                ...
                "scripts" => db_update
                    .scripts
                    .append(scripts_table::parse_table_update(table_update)?),
                "ticker" => db_update
                    .ticker
                    .append(ticker_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.assets = cache
            .apply_diff_to_table::<AssetFile>("assets", &self.assets)
            .with_updates_by_pk(|row| &row.path);
        diff.chunk = cache
            .apply_diff_to_table::<ChunkData>("chunk", &self.chunk)
            .with_updates_by_pk(|row| &row.key);
        diff.player = cache
            .apply_diff_to_table::<Player>("player", &self.player)
            .with_updates_by_pk(|row| &row.identity);
        diff.scripts = cache
            .apply_diff_to_table::<ScriptAsset>("scripts", &self.scripts)
            .with_updates_by_pk(|row| &row.asset_path);
        diff.ticker = cache
            .apply_diff_to_table::<Ticker>("ticker", &self.ticker)
...
pub struct AppliedDiff<'r> {
    assets: __sdk::TableAppliedDiff<'r, AssetFile>,
    chunk: __sdk::TableAppliedDiff<'r, ChunkData>,
    player: __sdk::TableAppliedDiff<'r, Player>,
    scripts: __sdk::TableAppliedDiff<'r, ScriptAsset>,
    ticker: __sdk::TableAppliedDiff<'r, Ticker>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<AssetFile>("assets", &self.assets, event);
        callbacks.invoke_table_row_callbacks::<ChunkData>("chunk", &self.chunk, event);
        callbacks.invoke_table_row_callbacks::<Player>("player", &self.player, event);
        callbacks.invoke_table_row_callbacks::<ScriptAsset>("scripts", &self.scripts, event);
        callbacks.invoke_table_row_callbacks::<Ticker>("ticker", &self.ticker, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        assets_table::register_table(client_cache);
        chunk_table::register_table(client_cache);
        player_table::register_table(client_cache);
        scripts_table::register_table(client_cache);
        ticker_table::register_table(client_cache);
    }
}
